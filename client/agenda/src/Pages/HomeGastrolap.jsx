    ...
    return ( 
        <Fragment>
               <div className="container">
                   <div className="row">
                       <div className="col-md-2 col-xs-6 mt-3 mb-3">
                                ...
                                <div className="container-fluid">
                                    ...
                                    <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                                        <div className="navbar-nav">
                                            <a className="nav-link fw-lighter fs-7" aria-current="page" href="/home"><i class="bi bi-file-earmark-person"></i> Pacientes para Estudios</a>
                                            <a className="nav-link fw-lighter fs-7" href="#">Features</a>
                                            <hr class="dropdown-divider" />
                                            <a className="nav-link fw-lighter fs-7" href="#"><i class="bi bi-x-circle"></i> Cerrar Sesion</a>
